...
**/
function abus_upgrade($nom_meta_base_version, $version_cible) {
	$maj = array();
	# quelques exemples
	...
	$maj['create'] = array(array('maj_tables', array('spip_abusobjets')));
	$maj['1.0.1'] = array(array('maj_tables', array('spip_abusobjets')));
...
**/
function abus_vider_tables($nom_meta_base_version) {
	# quelques exemples
	# (que vous pouvez supprimer !)
	# sql_drop_table("spip_xx");
	# sql_drop_table("spip_xx_liens");

	sql_drop_table("spip_abusobjets");
